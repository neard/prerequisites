...
Filename: "{tmp}\{#appId}\vcredist_2015_UPD3\vcredist_x86.exe"; Parameters: "/quiet /norestart"; StatusMsg: Installing Visual C++ 2015 UPD3 Runtimes x86 (VC14)...; Flags: runhidden waituntilterminated
Filename: "{tmp}\{#appId}\vcredist_2015_UPD3\vcredist_x64.exe"; Parameters: "/quiet /norestart"; StatusMsg: Installing Visual C++ 2015 UPD3 Runtimes x64 (VC14)...; Check: IsWin64; Flags: runhidden waituntilterminated
Filename: "{tmp}\{#appId}\vcredist_2017\vc_redist.x86.exe"; Parameters: "/quiet /norestart"; StatusMsg: Installing Visual C++ 2017 Runtimes x86 (VC15)...; Flags: runhidden waituntilterminated
Filename: "{tmp}\{#appId}\vcredist_2017\vc_redist.x64.exe"; Parameters: "/quiet /norestart"; StatusMsg: Installing Visual C++ 2017 Runtimes x64 (VC15)...; Check: IsWin64; Flags: runhidden waituntilterminated

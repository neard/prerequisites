...
Filename: "{tmp}\{#appId}\vcredist_2015_UPD1\vcredist_x86.exe"; Parameters: "/quiet /norestart"; StatusMsg: Installing Visual C++ 2015 UPD1 Runtimes x86 (VC14)...; Flags: runhidden waituntilterminated
Filename: "{tmp}\{#appId}\vcredist_2015_UPD1\vcredist_x64.exe"; Parameters: "/quiet /norestart"; StatusMsg: Installing Visual C++ 2015 UPD1 Runtimes x64 (VC14)...; Check: IsWin64; Flags: runhidden waituntilterminated
